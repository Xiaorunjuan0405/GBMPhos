...
def loss_fn(output, target, model, lambda_,device):  #https://cloud.tencent.com/developer/ask/sof/149180  https://zhuanlan.zhihu.com/p/259159952
...
def fit(model, train_loader, optimizer, criterion,device):
    ...
    for seq, label in train_loader:
        ...
        loss = loss + L1Loss(model, 0.00054)
