...
if __name__ == '__main__':
    ...
    blo_out, label = load_and_encoding_BLO("../../feature/BLOSUM62/data_ST.csv")
    blo_out = np.array(blo_out)

    zscale_out, label = load_and_encoding_ZCscale('../../feature/ZScale/data_ST.csv')
    zscale_out = np.array(list(zscale_out))

    bin51_out, label = load_and_encoding_bin51('../../feature/binary/data_ST_51.csv')
    bin51_out = np.array(bin51_out)

    bin52_out,label = load_and_encoding_bin52('../../feature/binary/data_ST_52.csv')
