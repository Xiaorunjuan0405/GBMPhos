...
class MultiScaleConvNet(nn.Module):
    def __init__(self):
        ...
        # 第二层卷积，对不同尺度下的序列进行卷积
        self.conv2_1 = nn.Conv1d(in_channels=64, out_channels=32, kernel_size=5, padding=1)
        self.conv2_2 = nn.Conv1d(in_channels=64, out_channels=32, kernel_size=7, padding=2)
        self.conv2_3 = nn.Conv1d(in_channels=64, out_channels=32, kernel_size=9, padding=3)
        ...
        self.fc = nn.Linear(in_features=3168, out_features=512)
