...
class MultiScaleConvNet(nn.Module):
    def __init__(self):
        ...
        self.lstm = nn.LSTM(input_size=128, hidden_size=32, bidirectional=True, batch_first=True)
        ...
        self.bn3 = nn.BatchNorm1d(1056)

        # 全连接层，将不同尺度下的特征拼接在一起并进行分类
        self.fc = nn.Linear(in_features=1056, out_features=512)
