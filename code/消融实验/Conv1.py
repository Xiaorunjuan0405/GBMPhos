...
class MultiScaleConvNet(nn.Module):
    def __init__(self):
        ...
        # 第一层卷积，对原始序列进行卷积
        self.conv1 = nn.Conv1d(in_channels=55, out_channels=128, kernel_size=7, padding=1)
        ...
        self.bn3 = nn.BatchNorm1d(2656)

        # 全连接层，将不同尺度下的特征拼接在一起并进行分类
        self.fc = nn.Linear(in_features=2656, out_features=512)
